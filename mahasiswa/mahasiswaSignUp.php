...
else
{
    ...
    $query = "INSERT INTO mahasiswa (nim, nama, password) VALUES ('$nim', '$nama', '$password')";
    ...
    if ($eksekusi)
    {
        ...
        echo "<script>window.location ='mahasiswaLogin.php';</script>";
    }
    else
    {
        // daftar gagal
...
<p><br>Sudah memiliki akun? <a href="mahasiswaLogin.php">Login sekarang!</a><br><br></p>
